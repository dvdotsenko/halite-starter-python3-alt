...
class Location:
    ...
    def __repr__(self):
        return super(Location, self).__repr__()[:-1] + " {},{}>".format(self.x, self.y)
...
class Move:
    ...
    def __init__(self, loc=None, direction=STAY):
        """
        :param loc:
        :type loc: Location
        :param direction:
    ...
    def __str__(self):
        return str(self.loc.x) + " " + str(self.loc.y) + " " + str(self.direction)

    def __repr__(self):
        return super(Move, self).__repr__()[:-1] + " {}>".format(self)
